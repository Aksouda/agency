export default {
  ...
  frontpage: {
    ...
    address1: '615 Hope Rd #3B',
    address2: 'Eatontown, NJ 07724',
    address3: 'United States',
    cookie_msg: 'We use cookies to offer you a personalized experience. It allows to activate them to benefit from their advantages.',
    ...
    cards: {
      ...
      scientific: {
        title: 'Jobs fitted to your skills',
        text: 'Success is only natural when you’re the best at what you do'
      }
    },
    description: {
...
inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
  ...
  toolbar: {
    ...
    compare_with: 'Compare your results'
  },
  facets: {
