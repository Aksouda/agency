export default {
  ...
  frontpage: {
    seo: {
      title: 'Recruto',
      title_can: 'Candidați - Recruto',
      title_comp: 'Angajatori - Recruto ',
      description: 'Recruto conectează candidații ideali cu companiile optime'
    },
    title: 'Recruto',
    contactus: 'Contactează-ne',
    title_footer: 'Hai să ne cunoaștem',
    policy: 'Acord de confidentialitate',
    address1: 'Bd. Iuliu Maniu 6L',
    address2: 'Sector 6, București,',
    address3: 'România',
    cookie_msg: 'Folosim cookie-uri pentru a-ti oferi o experienta personalizata. Permite activarea acestora pentru a beneficia de avantajele lor.',
...
inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
      ...
      info_hdpi: 'Recruto și ',
      info_hdpi1: ' lucrează împreună ca să îți oferim cea mai bună experiență de angajare.',
      hdpi: 'Human Performance Development Intl (HPDI) ',
      ang: 'ANG Luxury ',
